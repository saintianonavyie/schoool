	    		...
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md topper d-flex align-items-center justify-content-end">
					    	<p class="mb-0">
					    		<a href="admin/register.php" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
					    			<span>Apply now</span>
					    		</a>
					    	</p>
					    </div>
			...
			<div class="container-fluid px-4">
				<div class="row">
					<div class="col-md-3 course ftco-animate">
						...
						<div class="text pt-4">
							<p class="meta d-flex">
								<span><i class="icon-user mr-2"></i>Mr. Chris</span>
								<span><i class="icon-table mr-2"></i>10+ seats</span>
								<span><i class="icon-calendar mr-2"></i>4 Years</span>
							</p>
							<h3><a href="#">Computers Studies</a></h3>
							<p>Study to master all you need to know about computer and it's way of understanding. create and build machines that will use your input to simp,ifies life</p>
					...
					<div class="col-md-3 course ftco-animate">
						...
						<div class="text pt-4">
							<p class="meta d-flex">
								<span><i class="icon-user mr-2"></i>Mr. Frank</span>
								<span><i class="icon-table mr-2"></i>10+ seats</span>
								<span><i class="icon-calendar mr-2"></i>4 Years</span>
							</p>
							<h3><a href="#">Electric Engineering</a></h3>
							<p>Can do or have anything to with darkness and stress of life, simplicity and greatly working machines and gadgets to improve life. be the best Here.</p>
							<p><a href="#" class="btn btn-primary">Apply now</a></p>
						</div>
					</div>
					<div class="col-md-3 course ftco-animate">
						...
						<div class="text pt-4">
							<p class="meta d-flex">
								<span><i class="icon-user mr-2"></i>Mrs. Rita</span>
								<span><i class="icon-table mr-2"></i>10+ seats</span>
								<span><i class="icon-calendar mr-2"></i>4 Years</span>
							</p>
							<h3><a href="#">All about Health</a></h3>
							<p>Come up with your best in Research and inventions for solutions to the world greatest challengs to health related issues. Smatch it here </p>
							<p><a href="#" class="btn btn-primary">Apply now</a></p>
						</div>
					</div>
					<div class="col-md-3 course ftco-animate">
						...
						<div class="text pt-4">
							<p class="meta d-flex">
								<span><i class="icon-user mr-2"></i>Mr. Saint</span>
								<span><i class="icon-table mr-2"></i>10+ seats</span>
								<span><i class="icon-calendar mr-2"></i>4 Years</span>
							</p>
							<h3><a href="#">Defence and Law</a></h3>
							<p>voilence and tribulations everywhere, without edible one to instruct and protect both life and right of citizen. why waitng why resoursec for that are all here?. You need it comeOn</p>
							<p><a href="#" class="btn btn-primary">Apply now</a></p>
						</div>
					</div>
					<div class="col-md-3 course ftco-animate">
						...
						<div class="text pt-4">
							...
							<h3><a href="#">Designs and Building</a></h3>
