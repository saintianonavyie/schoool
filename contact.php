        ...
        <div class="row d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://07015516875">+234 701 551 6875</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
          		<h3 class="mb-4">Email Address</h3>
	            <p><a href="mailto:ferdinandchidubem3@gmail.com">ferdinandchidubem3@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light align-self-stretch box p-4 text-center">
          		<h3 class="mb-4">Website</h3>
	            <p><a href="">Edu-techInstitution.com</a></p>
	          </div>
          </div>
        </div>
      </div>
