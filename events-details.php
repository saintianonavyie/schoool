...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="EDU-TECH :The Success To Achieve" />
	
	<!-- OG -->
	<meta property="og:title" content="EDU-TECH :The Success To Achieve" />
	<meta property="og:description" content="EDU-TECH :The Success To Achieve" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>EDU-TECH INSTITUTION</title>
...
<div class="onepage"></div>
				...
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							...
							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>ferdinandchidubem3@gmail.com</a></li>
						</ul>
					</div>
								...
								<div class="row">
									<div class="col-md-12 col-lg-5">
										<ul class="course-features">
											...
											<li><i class="ti-help-alt"></i> <span class="label">Host</span> <span class="value">EDU-TECH</span></li>
    ...
    <footer>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 footer-col-4">
                        <div class="widget">
                            ...
                            <div class="subscribe-form m-b20">
								<form class="subscription-form" action="http:/demo/assets/script/mailchamp.php" method="post">
						...
						<div class="row">
							...
							<div class="col-4 col-lg-4 col-md-4 col-sm-4">
								<div class="widget footer_widget">
									...
									<ul>
										<li><a href="http://EDU-TECH.themetrades.com/admin/index.php">Dashboard</a></li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a target="_blank" href="https://www.templateshub.net">EDU-TECH INSTITUTION</a></div>
                </div>
            </div>
        </div>
    </footer>
